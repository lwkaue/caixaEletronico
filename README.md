...
Abra o projeto na sua IDE de preferência (ex: IntelliJ IDEA ou Eclipse).
Execute a classe CaixaEletronico.java, que contém o método main responsável por iniciar a lógica e abrir a interface gráfica.
Interface
